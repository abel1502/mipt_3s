...
public:
    ...
    constexpr bool isInside (const Vector2d &testPoint) const noexcept { return getDist(testPoint) >  0.; }
    constexpr bool isOutside(const Vector2d &testPoint) const noexcept { return getDist(testPoint) <= 0.; }
